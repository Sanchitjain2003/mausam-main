...
def set_up(key):
    if key == "temp":
        df1 = pd.read_csv(r"/home/pi/mausam/mausam-main/models/Final Datasets/nTemperature.csv")
        ...
        df2 = pd.read_csv(r"/home/pi/mausam/mausam-main/models/Final Datasets/nHumidity.csv")
        ...
        df3 = pd.read_csv(r"/home/pi/mausam/mausam-main/models/Final Datasets/nRainfall.csv")
